...
const DatePickerCode = `import { cn } from "@/lib/utils";
  ...
  return (
    <div ref={ref} className="relative">
      ...
      <input
        ...
        className={cn(
          \`dark:placeholder:text-grey/50 placeholder:text-darkbg/50 text-md border-darkbg/50 mt-3 min-h-8 w-full cursor-pointer rounded-lg border-2 bg-transparent px-4 py-2 placeholder:text-sm focus:outline-none dark:border-white/50 \${className}\`,
        )}
      ...
      {isCalendarOpen && (
        <div
          className={cn(
            \`dark:bg-darkbg absolute z-10 mt-2 min-w-72 overflow-hidden rounded-lg border-2 border-gray-300 bg-white shadow-lg \${className}\`,
          )}
        >
          {/* Top bar */}
